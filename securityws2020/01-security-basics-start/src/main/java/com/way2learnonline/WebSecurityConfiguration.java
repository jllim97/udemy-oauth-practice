...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/mylogin", "/h2-console").permitAll().anyRequest().authenticated().and()
				.formLogin().loginPage("/mylogin").defaultSuccessUrl("/hello", true).and().csrf().disable().rememberMe()
				.key("mykey");
		;
	}
	...
	// TODO-11 uncomment the below to configure jdbc authentication using
